...
import libcore.icu.Transliterator;		modify by genius		*/
...
public class ContactLocaleUtils {
    ...
    private static class ContactLocaleUtilsBase {
        ...
        public ContactLocaleUtilsBase(LocaleSet locales) {
            ...
            mAlphabeticIndex = ai.addLabels(Locale.ENGLISH)
                ...
                .addLabels(LOCALE_SERBIAN).buildImmutableIndex();
             //   .getImmutableIndex(); // modify by genius
  ...
  /*          if (bucketIndex < 0 || bucketIndex >= getBucketCount()) {
            ...
            return mAlphabeticIndex.getBucketLabel(bucketIndex); modify by genius*/
            
            if (bucketIndex == mNumberBucketIndex || bucketIndex < 0 || bucketIndex >= getBucketCount()) {
                return NUMBER_STRING;
            }
